...
pathres <- pathview(gene.data=foldchanges, pathway.id=keggresids, species="hsa")
```


**NUCLEOCYTOPLASMIC TRANSPORT**
```{r out.width = "100%"}
NucleocytoplasmicTransport <- pathres$hsa03013
knitr::include_graphics(paste(names(pathres)[1],"pathview.png",sep = "."), error = FALSE)
```

**CELL CYCLE**
```{r out.width = "100%"}
knitr::include_graphics(paste(names(pathres)[2],"pathview.png",sep = "."), error = FALSE)
```

**SPLICEOSOME**
```{r out.width = "100%"}
knitr::include_graphics(paste(names(pathres)[3],"pathview.png",sep = "."), error = FALSE)
```

**RIBOSOME**
```{r out.width = "100%"}
knitr::include_graphics(paste(names(pathres)[4],"pathview.png",sep = "."), error = FALSE)
```

**OXIDATIVE PHOSPHORYLATION**
```{r out.width = "100%"}
knitr::include_graphics(paste(names(pathres)[5],"pathview.png",sep = "."), error = FALSE)
```
